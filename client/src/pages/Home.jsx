  ...
  return (
    ...
    >
      ...
      <div className="w-full relative z-10 flex flex-col lg:flex-row items-stretch min-h-[500px] lg:min-h-[600px]">
        ...
        {/* Right Section: Mobile-Optimized Edge-to-Edge Auto-Playing Video Banner */}
        <div className="w-full lg:w-[60%] h-[260px] sm:h-[360px] lg:min-h-[600px] lg:h-full relative z-20 overflow-hidden bg-black flex items-center justify-center">
          <video
            src={fashionVideo}
            autoPlay
            loop
            muted
            playsInline
            className="w-full h-full object-cover lg:object-cover opacity-100"
          />
