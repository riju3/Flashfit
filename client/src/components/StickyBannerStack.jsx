...
const StickyBannerStack = () => {
  ...
  return (
    <section className="my-8 px-4 max-w-4xl mx-auto space-y-6">
      {banners.map((banner, index) => {
        ...
        return (
          <div
            ...
            className={`sticky rounded-[32px] p-6 sm:p-10 shadow-2xl text-white transition-all duration-300 bg-gradient-to-br ${gradientClass} border border-white/20 overflow-hidden group`}
            style={{
              top: `${90 + index * 14}px`,
              zIndex: 10 + index
            }}
