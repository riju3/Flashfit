    ...
    <section className='w-full container mx-auto px-2'>
            <div className='bg-white my-4 w-full max-w-lg mx-auto rounded p-7'>
                ...
                <form className='grid gap-4 py-4' onSubmit={handleSubmit}>
                    ...
                    <button disabled={!valideValue} className={` ${valideValue ? "bg-orange-600 hover:bg-orange-500" : "bg-gray-500" }    text-white py-2 rounded font-semibold my-3 tracking-wide`}>Change Password</button>
